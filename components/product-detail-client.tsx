...
export function ProductDetailClient({ product }: { product: Product }) {
  ...
  const handleAddToCart = () => {
    if (!selectedSize) {
      ...
      toast({
        title: t("sizeRequired"),
        description: t("pleaseSelectSizeDesc"),
        variant: "destructive",
        duration: 3000,
      })
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
        ...
        <div className="flex flex-col">
          <div className="mb-4 sm:mb-6">
            ...
            <p className="text-xl sm:text-2xl font-medium">€{product.price.toFixed(2)}</p>
          </div>
          ...
          <div className="border-t border-border pt-6 sm:pt-8">
            <h3 className="font-medium text-sm sm:text-base mb-3 sm:mb-4">{t("productDetails")}</h3>
          ...
          <div className="border-t border-border mt-6 sm:mt-8 pt-6 sm:pt-8 space-y-3 sm:space-y-4 text-xs sm:text-sm">
            ...
            <div>
              <h4 className="font-medium mb-2">{t("returnsExchanges")}</h4>
